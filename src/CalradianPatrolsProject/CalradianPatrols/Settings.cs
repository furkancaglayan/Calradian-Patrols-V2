...
namespace CalradianPatrolsV2.CalradianPatrols
{
    public class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyFloatingInteger("{=str_calradianpatrols_settings_1_0}Patrol Party Speed Bonus", 0f, 1f, "0%", Order = 0, RequireRestart = false, HintText = "{=str_calradianpatrols_settings_1_1}Increases patrol party speed.")]
        [SettingPropertyGroup("{=str_calradianpatrols_settings_advanced}Calradian Patrols - Advanced")]
        public float PatrolPartySpeedBonus { get; set; } = 0.1f;
        ...
        [SettingPropertyGroup("{=str_calradianpatrols_settings_basic}Calradian Patrols - Basic", GroupOrder = 0)]
        public int PatrolPartyCountPerTown { get; set; } = 5;
        ...
        [SettingPropertyGroup("{=str_calradianpatrols_settings_basic}Calradian Patrols - Basic", GroupOrder = 0)]
        public float BaseAISpawnPartyChance { get; set; } = 0.08f;
        ...
        [SettingPropertyGroup("{=str_calradianpatrols_settings_basic}Calradian Patrols - Basic", GroupOrder = 0)]
        public int AveragePartySize { get; set; } = 20;
